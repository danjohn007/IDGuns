...
-- Users (passwords: superadmin123, admin123, almacen123, bitacora123)
INSERT INTO `users` (`nombre`, `username`, `email`, `password`, `rol`, `activo`) VALUES
('Comandante Arturo Ríos Mendoza',     'superadmin',  'arios@ssc-qro.gob.mx',   '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uHpwKQgFi', 'superadmin', 1),
('Subcomandante Laura Vega Torres',    'lvega',       'lvega@ssc-qro.gob.mx',    '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uHpwKQgFi', 'admin',      1),
('Tte. Samuel Herrera Castillo',       'sherrera',    'sherrera@ssc-qro.gob.mx', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uHpwKQgFi', 'admin',      1),
('Sargento Diana López Morales',       'dlopez',      'dlopez@ssc-qro.gob.mx',   '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uHpwKQgFi', 'almacen',    1),
('Cabo Ernesto Salinas Pérez',         'esalinas',    'esalinas@ssc-qro.gob.mx', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uHpwKQgFi', 'bitacora',   1);

-- NOTE: The password hash above corresponds to 'password' (Laravel default test hash).
-- Replace with proper hashes generated by password_hash() in production.
